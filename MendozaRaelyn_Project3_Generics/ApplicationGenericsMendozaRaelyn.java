...
public class ApplicationGenericsMendozaRaelyn {
    public static void main(String[] args) {
        ...
        MendozaRaelyn_StackADTGenerics<MendozaRaelyn_Employee> employeesList = new MendozaRaelyn_StackADTGenerics<MendozaRaelyn_Employee>(capacity);
        ...
        while(!"quit".equalsIgnoreCase(userChoice)){
            ...
            if("help".equalsIgnoreCase(userChoice)){
                ...
                try {
                    MendozaRaelyn_Employee lastEmployee = employeesList.top();
